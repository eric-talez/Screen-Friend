...
> Status: Planning spec only (Slice 9A). No AI API, no implementation yet.
...
| **9B** | Sprite renderer foundation — `renderer: "sprite"` branch in CharacterStage, local placeholder PNG assets | No | Yes — renderer only |
